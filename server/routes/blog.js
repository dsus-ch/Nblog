...
router.delete('/delect-article', async (req, res) => await mianService.deleteArticle(req, res))
...
router.delete('/delect-category', async (req, res) => await otherService.deleteCategory(req, res))
